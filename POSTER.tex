...
\begin{minipage}{0.35\textwidth}
	% \begin{flushleft}
		\includegraphics[width=1.0\textwidth]{./floats/logos/rwth_acom_en_cmyk_fzj_gap.eps}
	% \end{flushleft}
\end{minipage}
}
\author{
...
\block{\bfseries Mathematical modelling for the next-generation All-solid-state batteries: Nucleation $\text{(SE|SSE)}^{\!(*)}$-interface}{
	\begin{minipage}{0.55\textwidth}
		...
		This bottleneck is mainly due to \underline{liquid-based electrolyte} in c-LIBs.
		
		\textbf{All-solid-state battery} (ASSB) is 
		one of promising candidates to overcome bottlenecks of c-LIBs. 
		Thanks to \underline{solid-state electrolyte} (SSE),
