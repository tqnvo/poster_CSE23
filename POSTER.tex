...
\begin{columns}
	...
	\block{Embedded structural-tensor SSE}
	{
		...
		and grains of various sizes \& shapes under microscopic observation.
		Hence, this type of microstructure is
		potentially prone to
		nuance destruction of 
		...
		\begin{align*}
			...
			\text{where}
			\quad
			\mathbb{G} := \left\{ \BQ_{||_{\Ba}}, \BQ_{\bot_{\Ba}}  \right\} \subset \mathcal{O}(3)
		\end{align*}
		\begin{center}
