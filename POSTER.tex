\documentclass[25pt, a0paper, portrait, margin=0mm, innermargin=15mm,
     blockverticalspace=15mm, colspace=15mm, subcolspace=0mm]{tikzposter}
...
\usepackage{caption}                         % no "Firgure" in caption
...
\institute{ACoM, Applied and Computational Mathematics, RWTH Aachen University
...
\titlegraphic{\includegraphics[width=0.5\textwidth]{./figs/logos/rwth_acom_en_cmyk.eps}}
...
\begin{columns}
	...
	\block{Next-generation All-solid-state battery}{
		...
		Yet, defect due to polarization is one natural phenomenon of \textbf{solid electrolyte} (SE) to be tackled.\\[0,5em]
	...
	\block{Continuum physics kinematic}{
		Green-Lagrange strain tensor $\BE$ with respect to \textbf{small} displacement $\partial\Bu/\partial\Bxi = \mathcal{O}(\epsilon), \ \epsilon \ll 1$:
		\begin{align*}
	...
	\block{Polarization phenomenon}{
		Due to a source of electric potential pointing from cathode $(+)$ to anode $(-)$ pole, a uniform electric field created has suppressed on 
		the SE occupied between these two poles. Consequently, SE yields to a \textbf{preferred direction} under external deformations such as mechanical loading forces.
