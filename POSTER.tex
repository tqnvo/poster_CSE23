...
% 	% \begin{flushleft}
% 	% 	\includegraphics[width=0.99\textwidth]{./floats/logos/rwth_acom_en_cmyk_siamcse23_fzj_gap.eps}
% 	% \end{flushleft}
% \end{minipage}
}
% \author{
...
\begin{columns}
	...
	\block{References}{
		...
		\begin{thebibliography}{2}
			...
			Master thesis, Robert Bosch Battery Systems GmbH, 2018.
			...
			\emph{High-energy and durable lithium metal batteries using garnet-type
