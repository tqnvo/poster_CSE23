...
\titlegraphic{\includegraphics[width=0.2\textwidth]{./floats/logos/rwth_acom_en_cmyk_siamcse23_fzj_gap.eps}}
...
% ---------------------------------------------------------------------------------------------------------------- %
\block{\bfseries Improvement: Nucleation $\text{(SE|SSE)}^{\!(*)}$-interface}{
	\begin{columns}
		\column{0.5}
		Goal:
		\begin{align}
