...
\begin{columns}
	...
	% ---------------------------------------------------------------------------------------------------------------- %
	\column{0.6}
	\block{Electrical field + Polarization + Structural tensor}{
...
\block{Nucleation interface: Taking place at the critical dendritic interface}{
	...
	\hfill
	\begin{minipage}{0.50\textwidth}
		Distribution of the analytical maximal shear stress component $\WAsigma^{\Pi}_{x_1x_2}$, around the crack tip $a_{c}$.
		\begin{center}
			\inputfig{floats/maxshear_9figs_456}{maxshear_9figs_456}
		\end{center}
	...
	Nucleation interface: Taking place at the critical dendritic interface
	Nucleation interface: Taking place at the critical dendritic interface (Solid electrode | Solid-state electrolyte)
	Nucleation interface: Taking place at the critical dendritic interface
}
\begin{columns}
