...
\title{\bfseries Next-generation all-solid-state battery:
\bfseries Nucleation $\text{(SE|SSE)}^{\!(*)}$-interface}
...
\titlegraphic{\includegraphics[width=0.88\textwidth]{./floats/logos/rwth_acom_en_cmyk_siamcse23_fzj_gap.eps}}
...
\begin{columns}
	...
	\column{0.5}
	% ---------------------------------------------------------------------------------------------------------------- %
	\block{Why: Next-generation All-solid-state battery (ASSB)}{
		...
		\textbf{Next-generation all-solid-state battery}
