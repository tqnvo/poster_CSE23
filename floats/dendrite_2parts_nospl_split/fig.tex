...
\psfrag{sse}[c][c] {$\text{\scriptsize Solid-state electrolyte}$}

\psfrag{masca}[c][c] {$\text{\scriptsize Macroscale}$}
\psfrag{mesca}[c][c] {$\text{\scriptsize Mesoscale}$}
\psfrag{misca}[c][c] {$\text{\scriptsize Microscale}$}
