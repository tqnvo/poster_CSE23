...
\psfrag{cu}[r][r] {$\scriptsize  \text{copper}$}
\psfrag{alu}[l][l] {$\scriptsize  \text{aluminum}$}

\psfrag{cur1}[r][r] {$\scriptsize  \text{current}$}
\psfrag{col1}[r][r] {$\scriptsize  \text{collector}$}

\psfrag{cur2}[l][l] {$\scriptsize  \text{current}$}
\psfrag{col2}[l][l] {$\scriptsize  \text{collector}$}
...
\psfrag{el}[c][c] {$\scriptsize  \text{Solid electrolyte}$}
...
\psfrag{ch}[c][c] {$\scriptsize  \text{charging}$}

\includegraphics[width=0.99\textwidth]{dendrite_pdirection_battonly_maths.eps}